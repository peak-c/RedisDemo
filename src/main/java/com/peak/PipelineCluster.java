 ...
 * 该类非线程安全
 */
public class PipelineCluster extends PipelineBase implements Closeable {
	private static final Logger LOGGER = LoggerFactory.getLogger(PipelineCluster.class);
	...
	/**
	 * 根据jedisCluster实例生成对应的PipelineCluster
	 * 
	 * @param
	 * @return
	 */
	public static PipelineCluster pipelined(JedisCluster jedisCluster) {
		PipelineCluster pipeline = new PipelineCluster();
